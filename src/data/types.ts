...
type DataBattleUnit = {
	...
	to?: DateValue;
	from?: DateValue;
	airfields?: [[string, DateValue?, DateValue?, number?]];
	planes?: [[string, number | [number, number], DateValue?, DateValue?]];
	pilots?: [[string, number, DateValue?, DateValue?]];
};
...
type DataBattleUnitTransformed = Immutable<
	DataBattleUnit & {
		country: Country;
	}
>;
